...
# Compare them
```{r racewithinyearcompare}
subset(tempdf[,c(1,2,4)],sid==3 &school_year<2007 | sid==8552 &school_year<2007 | sid==11382 &school_year<2007)

subset(stuatt[,c(1,2,4)],sid==3 &school_year<2007 | sid==8552 &school_year<2007 | sid==11382 &school_year<2007)
```
