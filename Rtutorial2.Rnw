...
#load("C:/git/LDS_TOOLS/packagedata.rda") # load data sets
#source('C:/git/LDS_TOOLS/mosaicplotdraft.R') # source R scripts
#load("~/LDS_TOOLS/packagedata.rda") # Alternate directory
#source('~/LDS_TOOLS/mosaicplotdraft.R') #Alternate directory for Linux
options(width=60) # make verbatim R code fit
@
